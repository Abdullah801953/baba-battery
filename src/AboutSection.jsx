          ...
          <div className="col-xl-6 mt-1-9">
            <div className="position-relative ms-lg-5 about-img">
              <div className="text-center text-sm-end pb-sm-17">
                <img decoding="async" src="/src/img/content/about4.jpg" alt="About image1" />
              </div>
              <img decoding="async" src="/src/img/content/about5.jpg" className="position-absolute bottom-0 d-none d-sm-block" alt="About image2" />
              <div className="about-img-content d-none d-sm-block">
                <h3 className="h4 mb-3">Wind & Solar Energy</h3>
                <img decoding="async" src="/src/img/avatars/avatar-08.jpg" className="rounded-circle w-60px mb-3" alt="About image3" />
                <div>
                  <img decoding="async" src="/src/img/content/signature-2.png" alt="About image4" />
                </div>
              </div>
            </div>
          </div>
