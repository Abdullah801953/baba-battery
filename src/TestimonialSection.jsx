  ...
  return (
    <section className="pt-23">
                  ...
                  <div className="owl-item cloned" style={{width: '856px', marginRight: '50px'}}>
                    <div>
                      ...
                      <div className="d-flex justify-content-center align-items-center">
                        <div className="me-3">
                          <img decoding="async" src="/src/img/avatars/avatar-03.jpg" className="rounded-circle" alt="Author Image" />
                        </div>
      ...
      <div className="position-absolute left-15 top-20">
        <img src="/src/img/avatars/avatar-04.jpg" className="rounded-circle d-md-block d-none" alt="..." />
      </div>
      <div className="position-absolute left-10 bottom-15">
        <img src="/src/img/avatars/avatar-06.jpg" className="rounded-circle d-lg-block d-none" alt="..." />
      </div>
      <div className="position-absolute right-5 top-10">
        <img src="/src/img/avatars/avatar-07.jpg" className="rounded-circle w-70 d-md-block d-none" alt="..." />
      </div>
      <div className="position-absolute right-20 bottom-25">
        <img src="/src/img/avatars/avatar-05.jpg" className="rounded-circle d-xl-block d-none" alt="..." />
      </div>
    </section>
  );
}
