            ...
            },
            {
              ...
              value: function () {
                ...
                (n.position = i.image.position),
                  ...
                  i.onResize(),
                  i.onScroll(!0),
                  i.options.automaticResize && $ && $.observe(i.$item),
              ...
              value: function (t) {
                ...
                l.options.elementInViewport &&
                  ...
                  (l.isElementInViewport =
                    0 <= p.bottom && 0 <= p.right && p.top <= m && p.left <= f),
        ...
        for (
          ...
          if (
            ("object" === (void 0 === i ? "undefined" : l(i)) || void 0 === i
              ? t[s].jarallax || (t[s].jarallax = new T(t[s], i))
              : t[s].jarallax && (r = t[s].jarallax[i].apply(t[s].jarallax, o)),
            void 0 !== r)
          )
            return r;
        return t;
        ...
        f(this).on("bind", "tabactivate", function (t, e) {
          ...
          this.each(function () {
            ...
            o
              ...
              1 == u && o.css({ width: "100%", margin: "0px" }),
              "accordion" == c &&
          ...
          if ((C(), t.src)) {
            ...
            return (
              n.length
                ? ((i = n[0].parentNode) &&
                    i.tagName &&
                    (S || (($ = o.hiddenClass), (S = d($)), ($ = "mfp-" + $)),
                    (T = n.after(S).detach().removeClass($))),
  ...
  (function (t, e) {
    ...
    function m(t) {
      if (
        ...
        o = p(e.height);
        return (
          !1 !== o && (i.height = o + (t ? 0 : l + h)),
          (i.innerWidth = i.width - (a + d)),
          (i.innerHeight = i.height - (l + h)),
        ...
        c.docReady(function () {
          ...
          t.forEach(function (e) {
            ...
            try {
              ...
              return void (
                u &&
                u.error("Error parsing " + n + " on " + e.className + ": " + t)
              );
            }
            var o = new a(e, t);
            r && r.data(e, l, o);
      ...
      z = {
        ...
        util: {
          encode: function (t) {
            return t instanceof I
              ? new I(t.type, z.util.encode(t.content), t.alias)
              : Array.isArray(t)
              ? t.map(z.util.encode)
              : t
                  .replace(/&/g, "&amp;")
        ...
        languages: {
          ...
          insertBefore: function (i, t, e, o) {
            ...
            return (
              (o[i] = r),
              z.languages.DFS(z.languages, function (t, e) {
                e === l && t != i && (this[t] = r);
              }),
              r
            );
        ...
        highlightAllUnder: function (t, e, i) {
          ...
          for (
            ...
            z.highlightElement(n, !0 === e, o.callback);
        },
        highlightElement: function (t, e, i) {
          ...
          function r(t) {
            (a.highlightedCode = t),
              z.hooks.run("before-insert", a),
              (a.element.innerHTML = a.highlightedCode),
              z.hooks.run("after-highlight", a),
              z.hooks.run("complete", a),
              i && i.call(a.element);
          }
          var a = { element: t, language: n, grammar: o, code: t.textContent };
          z.hooks.run("before-sanity-check", a),
            a.code
              ? (z.hooks.run("before-highlight", a),
                a.grammar
                  ? e && l.Worker
                    ? (((e = new Worker(z.filename)).onmessage = function (t) {
                        r(t.data);
                      }),
                      e.postMessage(
                        JSON.stringify({
                    ...
                    : r(z.highlight(a.code, a.grammar, a.language))
                  : r(z.util.encode(a.code)))
              : z.hooks.run("complete", a);
        },
        highlight: function (t, e, i) {
          i = { code: t, grammar: e, language: i };
          return (
            z.hooks.run("before-tokenize", i),
            (i.tokens = z.tokenize(i.code, i.grammar)),
            z.hooks.run("after-tokenize", i),
            I.stringify(z.util.encode(i.tokens), i.language)
          );
        },
        matchGrammar: function (t, e, i, o, n, s, r) {
          for (var a in i)
            if (i.hasOwnProperty(a) && i[a]) {
              if (a == r) return;
              for (
                var l = i[a], l = "Array" === z.util.type(l) ? l : [l], c = 0;
                c < l.length;
                ++c
              ) {
                var u,
                  ...
                  if (!(b instanceof I)) {
                    ...
                    if (S) {
                      ...
                      if (
                        ...
                        1 != T && z.matchGrammar(t, e, i, y, v, !0, a),
                        s)
                      )
                        break;
                    } else if (s) break;
            ...
            l.addEventListener(
              ...
              function (t) {
                var e = JSON.parse(t.data),
                  ...
                  t = e.code,
                  e = e.immediateClose;
                l.postMessage(z.highlight(t, z.languages[i], i)),
                  e && l.close();
              },
              !1
            )),
      ...
      t &&
        ...
        z.manual ||
          ...
          ("loading" !== document.readyState
            ? window.requestAnimationFrame
              ? window.requestAnimationFrame(z.highlightAll)
              : window.setTimeout(z.highlightAll, 16)
            : document.addEventListener("DOMContentLoaded", z.highlightAll))),
      z
    );
  })(_self);
